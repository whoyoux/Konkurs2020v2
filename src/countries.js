const countries = [
  ...
  { name_pl: "Boliwia", name_en: "Bolivia, Plurinational State of", code: "BO" },
  { name_pl: "Bonaire, Sint Eustatius i Saba", name_en: "Bonaire, Sint Eustatius and Saba", code: "BQ" },
  { name_pl: "Bośnia i Hercegowina", name_en: "Bosnia and Herzegovina", code: "BA" },
  ...
  { name_pl: "Brytyjskie Terytorium Oceanu Indyjskiego", name_en: "British Indian Ocean Territory", code: "IO" },
  { name_pl: "Brytyjskie Wyspy Dziewicze", name_en: "Virgin Islands, British", code: "VG" },
  ...
  { name_pl: "Falklandy", name_en: "Falkland Islands (Malvinas)", code: "FK" },
  ...
  { name_pl: "Francuskie Terytoria Południowe i Antarktyczne", name_en: "French Southern Territories", code: "TF" },
  { name_pl: "Gabon", name_en: "Gabon", code: "GA" },
  { name_pl: "Gambia", name_en: "Gambia", code: "GM" },
  { name_pl: "Georgia Południowa i Sandwich Południowy", name_en: "South Georgia and the South Sandwich Islands", code: "GS" },
  ...
  { name_pl: "Macedonia", name_en: "Macedonia, the former Yugoslav Republic of", code: "MK" },
  ...
  { name_pl: "Mariany Północne", name_en: "Northern Mariana Islands", code: "MP" },
  ...
  { name_pl: "Mikronezja", name_en: "Micronesia, Federated States of", code: "FM" },
  ...
  { name_pl: "Palestyna", name_en: "Palestinian Territory, Occupied", code: "PS" },
  ...
  { name_pl: "Republika Południowej Afryki", name_en: "South Africa", code: "ZA" },
  { name_pl: "Republika Środkowoafrykańska", name_en: "Central African Republic", code: "CF" },
  { name_pl: "Republika Zielonego Przylądka", name_en: "Cape Verde", code: "CV" },
  { name_pl: "Reunion", name_en: "Réunion", code: "RE" },
  { name_pl: "Rosja", name_en: "Russia", code: "RU" },
  ...
  { name_pl: "Saint Kitts i Nevis", name_en: "Saint Kitts and Nevis", code: "KN" },
  { name_pl: "Saint Lucia", name_en: "Saint Lucia", code: "LC" },
  { name_pl: "Saint Vincent i Grenadyny", name_en: "Saint Vincent and the Grenadines", code: "VC" },
  { name_pl: "Saint-Barthélemy", name_en: "Saint Barthélemy", code: "BL" },
  { name_pl: "Saint-Martin", name_en: "Saint Martin (French part)", code: "MF" },
  { name_pl: "Saint-Pierre i Miquelon", name_en: "Saint Pierre and Miquelon", code: "PM" },
  ...
  { name_pl: "Sint Maarten", name_en: "Sint Maarten (Dutch part)", code: "SX" },
  ...
  { name_pl: "Svalbard i Jan Mayen", name_en: "Svalbard and Jan Mayen", code: "SJ" },
  ...
  { name_pl: "Tanzania", name_en: "Tanzania, United Republic of", code: "TZ" },
  ...
  { name_pl: "Trynidad i Tobago", name_en: "Trinidad and Tobago", code: "TT" },
  ...
  { name_pl: "Turks i Caicos", name_en: "Turks and Caicos Islands", code: "TC" },
  ...
  { name_pl: "Watykan", name_en: "Holy See (Vatican City State)", code: "VA" },
  { name_pl: "Wenezuela", name_en: "Venezuela, Bolivarian Republic of", code: "VE" },
  ...
  { name_pl: "Wybrzeże Kości Słoniowej", name_en: "Côte d'Ivoire", code: "CI" },
  { name_pl: "Wyspa Bouveta", name_en: "Bouvet Island", code: "BV" },
  { name_pl: "Wyspa Bożego Narodzenia", name_en: "Christmas Island", code: "CX" },
  { name_pl: "Wyspa Man", name_en: "Isle of Man", code: "IM" },
  { name_pl: "Wyspa Świętej Heleny, Wyspa Wniebowstąpienia i Tristan da Cunha", name_en: "Saint Helena, Ascension and Tristan Cunha", code: "SH" },
  { name_pl: "Wyspy Alandzkie", name_en: "Åland Islands", code: "AX" },
  { name_pl: "Wyspy Cooka", name_en: "Cook Islands", code: "CK" },
  { name_pl: "Wyspy Dziewicze Stanów Zjednoczonych", name_en: "Virgin Islands, U.S.", code: "VI" },
  { name_pl: "Wyspy Heard i McDonalda", name_en: "Heard Island and McDonald Islands", code: "HM" },
  { name_pl: "Wyspy Kokosowe", name_en: "Cocos (Keeling) Islands", code: "CC" },
  ...
  { name_pl: "Wyspy Świętego Tomasza i Książęca", name_en: "Sao Tome and Principe", code: "ST" },
  ...
  { name_pl: "USA", name_en: "USA", code: "US" }
];
